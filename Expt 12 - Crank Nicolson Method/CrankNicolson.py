# Crank Nicholson Method to solve Parabolic ODEs(Heat Equation)

# Tapan Mayukh - 170121048 - 04/11/2019
...
if __name__ == "__main__":
	...
	with open("data2.dat", "w") as f:
		for i in range(len(x)):
			if i == 0:
				f.write("{} {} {} {} {} {}\n".format(x[i], b[i][0], b[i][0], b[i][0], b[i][0], b[i][0]))
			elif i == len(x) - 1:
				f.write("{} {} {} {} {} {}\n".format(x[i], b[-1][0], b[-1][0], b[-1][0], b[-1][0], b[-1][0]))
			else:
				f.write("{} {} {} {} {} {}\n".format(x[i], u_evol[100][i - 1][0], u_evol[500][i - 1][0], u_evol[1000][i - 1][0], u_evol[5000][i - 1][0], u_evol[-1][i - 1][0]))
